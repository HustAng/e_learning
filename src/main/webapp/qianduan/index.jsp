...
<body>
	<div class="t">
 		 <div class="t_n">
    		<div class="r_nr"><a href="#">我的学习</a>&nbsp;<a href="#">消息<em id="msg_num">2</em></a>&nbsp;<a href="#">购物车<em id="buy_num">1</em></a>&nbsp;<a href="login.html">登录/注册</a></div>
 	 	</div>
	</div>
	<div class="header">
		...
		<div class="incredible">
				<div class="container">
					<h3>热门课程</h3>
						<div class="incredible-grids">
							<div class="col-md-3 incredible-grid">
								<img src="/images/hot1.jpg" class="img-responsive" alt="/">
								<h4><a href="#">金牌口语课--中外教联袂出击</a></h4>
								<p>沪江网校</p>
								<p><span>￥288</span>（1401人学过）</p>
							</div>
							<div class="col-md-3 incredible-grid">
								<img src="/images/hot2.jpg" class="img-responsive" alt="/">
								<h4><a href="#">帮你学音标语音</a></h4>
								<p>帮你学英语</p>
								<p><span>￥299</span>（468人学过）</p>
							</div>
							<div class="col-md-3 incredible-grid">
								<img src="/images/hot3.jpg" class="img-responsive" alt="/"> 
								<h4><a href="#">紧跟商业趋势--学地道英语</a></h4>
									<p>BenAtive商务英语</p>
								<p><span>￥199</span>（1888人学过）</p>
							</div>
							<div class="col-md-3 incredible-grid">
								<img src="/images/hot4.jpg" class="img-responsive" alt="/">
				...
				<!--名师-->
					<div class="models">
						<div class="container">
							...
							<div class="clients">
								<ul id="flexiselDemo3">
									<li><img src="/images/m1.jpg" class="img-responsive" alt=""/><h4>周雷</h4><p>北京大学英语系英语语言文学硕士</p></li>
									<li><img src="/images/m2.jpg" class="img-responsive" alt=""/><h4>孙菁笛</h4><p>悉尼大学硕士</p></li>
									<li><img src="/images/m3.jpg" class="img-responsive" alt=""/><h4>刘强</h4><p>2012财年新东方集团优秀教师</p></li>
									<li><img src="/images/m4.jpg" class="img-responsive" alt=""/><h4>史学冬</h4><p>从事高等英语教育18年</p></li>
									<li><img src="/images/m5.jpg" class="img-responsive" alt=""/><h4>孙思扬</h4><p>英语专八教育8年</p></li>
									<li><img src="/images/m1.jpg" class="img-responsive" alt=""/><h4>周雷</h4><p>北京大学英语系英语语言文学硕士</p></li>
									<li><img src="/images/m2.jpg" class="img-responsive" alt=""/><h4>孙菁笛</h4><p>悉尼大学硕士</p></li>
									<li><img src="/images/m3.jpg" class="img-responsive" alt=""/><h4>刘强</h4><p>2012财年新东方集团优秀教师</p></li>
									<li><img src="/images/m4.jpg" class="img-responsive" alt=""/><h4>史学冬</h4><p>从事高等英语教育18年</p></li>
